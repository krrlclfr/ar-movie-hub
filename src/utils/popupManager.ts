...
export function closeCurrentPopupTab(): boolean {
  try {
...
export function closePopupTriggeredByIframe(): boolean {
  closeAllPopups()
  return closeCurrentPopupTab()
}
...
export const popupManager = {
  ...
  closeAllPopups,
  getOpenPopups,
  closeCurrentPopupTab,
  closePopupTriggeredByIframe,
}
